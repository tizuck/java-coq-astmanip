...
public class ImportModuleBinding implements ModuleBinding {

	private List<Ident> ids;

	private ModuleType moduleType;

	public ImportModuleBinding(List<Ident> ids, ModuleType moduleType) {
		this.ids = ids;
	...
	public boolean equals(Object o) {
		...
		ImportModuleBinding that = (ImportModuleBinding) o;
