...
public class ExportModuleBinding implements ModuleBinding {

	private List<Ident> ids;

	private ModuleType moduleType;

	public ExportModuleBinding(List<Ident> ids, ModuleType moduleType) {
		this.ids = ids;
	...
	public boolean equals(Object o) {
		...
		ExportModuleBinding that = (ExportModuleBinding) o;
